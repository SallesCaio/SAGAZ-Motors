        ...
        <div class="row align-items-center min-vh-75">
            <div class="col-lg-6">
                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="pages/modelo.php?slug=m400" class="btn btn-outline-light btn-lg">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card model-card h-100">
                    <div class="card-img-wrapper">
                        <img src="<?= $modelo['imagem'] ?>" class="card-img-top" alt="SAGAZ <?= $modelo['nome'] ?>">
                        <div class="card-overlay">
                            <a href="pages/modelo.php?slug=<?= $modelo['slug'] ?>" class="btn btn-danger">
